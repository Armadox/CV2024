...
const Projects = () => {
    ...
    const Project = ({title, description, content, footer}: {title: string, description: string, content: React.ReactNode, footer: string}) => {
        return (
            <Card className="w-[450px] min-h-[250px] sm:w-[600px] sm:min-h-[300px] lg:w-[650px] lg:min-h-[400px] mx-5 bg-zinc-800 border-none">
                <CardHeader>
                    ...
                    <CardDescription className="text-zinc-500 text-center text-sm lg:text-md">{description}</CardDescription>
                </CardHeader>
                ...
                <CardFooter className="flex flex-col justify-center items-center text-zinc-500 text-center text-xs lg:text-md">
                    ...
                    <div>GitHub: <Link href={footer} className="underline text-main">Click Here!</Link></div>
                </CardFooter>}
            </Card>
        )
    }
    ...
    <div>
        ...
        <div className="flex justify-center items-center mt-5">
            ...
            content={
                <div>
                    <div className="pb-2 lg:pb-4">A quick and dirty real-time chat messenger that uses Websockets for instant messaging.</div>
                    <div className="pb-2 lg:pb-4">Users sign up through google accounts with NextAuth.</div>
                    <div className="pb-2 lg:pb-4">Proper UDP connection using LiveKit SDK(SFU) so you can voice chat.</div>
                    <div className="pb-2 lg:pb-4">You can check it out here: <Link className="underline text-main" href="https://adoring-poitras.212-72-171-49.plesk.page/servers/672d4dcab52918b216dc0e97/channels/672d4dcab52918b216dc0e98">Link</Link></div>
                </div>
            } 
            ...
            <div>
                ...
                <div className="pb-2 lg:pb-4">Has an admin panel where you can create, read, update and delete products and orders.</div>
                <div className="pb-2 lg:pb-4">Functioning Stripe payment with hooks to update our server.</div>
                <div className="pb-2 lg:pb-4">Utilized server-side rendering and dynamically loaded client components to achieve a google page speed score of 95-100 on desktop and mobile.</div>
                <div>You can check it out here: <Link className="underline text-main" href="https://gym-and-more.at">Link</Link></div>
            </div>} 
            footer={""}/>
            ) : numbers === "142511" ? (
            <Project 
            ...
            content={
            <div>
                <div className="pb-2 lg:pb-4">Dynamic website that uses Php, MySQL as backend and HTML, CSS, Sass, Javascript, Bootstrap-5 and React as frontend.</div>
                <div className="pb-2 lg:pb-4">Backend and frontend communicate through JSON data.</div>
                <div className="pb-2 lg:pb-4">Php files have extended classes and is OOP based.</div>
