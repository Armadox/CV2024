...
const AboutMe: React.FC<AboutMeProps> = ({
  ...
  return (
    <div
      className={`flex flex-col flex-none md:flex-row justify-evenly items-center py-[1rem] ${className}`}
    >
      <Image
        src={image}
        width={900}
        height={900}
        alt={""}
        className={`grayscale hover:grayscale-0 w-[400px] h-[400px] object-contain rounded-full transition-all duration-500 ${
