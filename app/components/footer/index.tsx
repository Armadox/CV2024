...
const Footer = () => {
  return (
    <div
      id="contact"
      className="flex flex-col md:flex-row items-center justify-between section"
    >
      <div className="flex w-full justify-evenly h-[300px] md:h-[120px] py-4 space-x-4 text-sm">
        <div className="flex flex-col px-1 md:px-6">
          <div className="font-extrabold mb-2 flex items-center py-[2px]">
            <PiNotebookLight />
            Address:
          </div>
          ...
          <div className="font-extrabold mt-4 mb-2 md:hidden flex items-center py-[2px]">
            <FaUser />
            Contact:
          </div>
          <div className="md:hidden flex items-center py-[2px]">
            <IoPhonePortraitSharp />
            +43 (0)660 183 2293
          </div>
          <div className="md:hidden flex items-center py-[2px]">
            <TiMail />
            adydan1802@gmail.com
          </div>
        </div>
        ...
        <div className="flex flex-col px-1 md:px-6">
          ...
          <div>
            <Link
              href={"https://www.linkedin.com/in/adrian-d-771174226/"}
              className="flex items-center py-[2px]"
            >
              <FaLinkedin />
              LinkedIn
        ...
        <Separator orientation="vertical" className="hidden md:block" />
        <div className="flex flex-col px-1 md:px-6 hidden md:block">
          <div className="flex justify-center items-center font-extrabold mb-2 hidden md:block">
            Downloads:
          </div>
          <div>
            <Link
