...
const Header = () => {
  ...
  return (
    <div
      className={`fixed top-0 flex overflow-x-scroll z-50 w-full transition-all duration-300 ${
        isScrolled ? "bg-zinc-950 h-[4rem]" : "bg-zinc-900 h-[10rem]"
      }`}
    >
      <div className="flex flex-none w-full justify-evenly min-w-[800px] items-center">
        <div className="relative group">
          ...
          <div
            className={`absolute left-0 -bottom-1 h-[2px] bg-main transition-all duration-300 group-hover:w-full 
                            ${
                              currentSections.length > 1
                                ? currentSections[1] === "about-me"
                                  ? "w-full"
                                  : "w-0"
                                : currentSections[0] === "about-me"
                                ? "w-full"
                                : "w-0"
                            }
                            `}
        ...
        <div className="relative group">
          ...
          <div
            className={`absolute left-0 -bottom-1 h-[2px] bg-main transition-all duration-300 group-hover:w-full ${
              currentSections[0] === "skills" || currentSections[1] === "skills"
                ? "w-full"
                : "w-0"
            }`}
          ></div>
        ...
        <div className="relative group">
          ...
          <div
            className={`absolute left-0 -bottom-1 h-[2px] bg-main transition-all duration-300 group-hover:w-full ${
              currentSections[0] === "experience" ||
              currentSections[1] === "experience"
                ? "w-full"
                : "w-0"
            }`}
          ></div>
        ...
        <div className="relative group">
          ...
          <div
            className={`absolute left-0 -bottom-1 h-[2px] bg-main transition-all duration-300 group-hover:w-full ${
              currentSections[0] === "projects" ||
              currentSections[1] === "projects"
                ? "w-full"
                : "w-0"
            }`}
          ></div>
        ...
        <div className="relative group">
          ...
          <div
            className={`absolute left-0 -bottom-1 h-[2px] bg-main transition-all duration-300 group-hover:w-full ${
              currentSections[0] === "contact" ||
              currentSections[1] === "contact"
                ? "w-full"
                : "w-0"
            }`}
          ></div>
