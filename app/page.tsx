  ...
  const experience = [
    {
      ...
      content: (
        <div>
          <ul>
            <li>
              Developed a fully dynamic CMS WordPress website with a fully
              functioning custom theme, that I achieved by changing WordPress
              PHP files and installing SASS (CSS extension) for enhanced
              styling.
              <ul className="text-sm text-zinc-300">
                <li>
                  The website utilized PHP and MySQL to establish our database
    ...
    },
    {
      ...
      content: (
        <div>
          <ul>
            <li>
              RetreatPartner is a dynamic online platform dedicated to
              connecting people who seek to either participate in seminars and
              retreats or wish to host them.
            </li>
            <li>
              Worked within a dynamic team of front-end and back-end developers.
              <ul className="text-sm text-zinc-300">
                <li>
                  Utilized Next.js and Tailwind to develop and optimize
                  front-end interfaces to effectively showcase content and
                  ensure an ideal user experience.
                </li>
                <li>
                  Worked on our GraphQL front-end code to optimize the exchange
                  of data between client and server.
                </li>
                <li>
                  Used GitHub/SourceTree to ensure a straightforward and easy
                  integration of new features into test builds before deploying
                  them on the main build.
                </li>
              </ul>
            </li>
          </ul>
    ...
    },
    {
      ...
      content: (
        <div>
          <ul>
            <li>
              Founded and developed gym-and-more.at, an online e-shop
              specialized in selling supplements.
              <ul className="text-sm text-zinc-300">
                <li>
                  Used Next.js and Tailwind CSS with a mobile-first approach for
                  optimal front-end development, resulting in a very fast,
                  snappy, and dynamic layout.
                </li>
                <li>
                  Implemented Prisma to construct a flexible and efficient data
                  model for users, products, and orders.
                </li>
              </ul>
            </li>
            <li>
  ...
  return (
    <div className="text-zinc-200 bg-zinc-950 w-full">
      ...
      <Container className="bg-zinc-900 py-20 min-h-[800px]">
        <div className="text-xl text-center lg:text-5xl lg:text-start mb-5">
          I worked as a...
        </div>
